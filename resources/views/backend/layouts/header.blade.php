...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('backend/vendor/datatables/css1/jquery.dataTables.min.css') }}">
    <link rel="stylesheet" href="{{ asset ('backend/vendor/datatables/css1/buttons.dataTables.min.css') }}">
